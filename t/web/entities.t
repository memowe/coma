...
$t->get_ok('/entities')->status_is(200)->text_is(h1 => 'All Entities');

subtest 'Entity cloud' => sub {
    my $text = $t->tx->res->dom('#entity_cloud')->first->all_text;
    is no_ws($text) => 'a b digit letter', 'Four entities';
};
...
subtest 'Entity table' => sub {
    ...
    subtest 'Data' => sub {
        ...
        is_deeply $data => [
            'digit 0.4278 2 (in: 0, out: 2)',
            'a 0.2608 3 (in: 1, out: 2)',
