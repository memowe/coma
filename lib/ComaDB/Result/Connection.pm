...
__PACKAGE__->belongs_to(from_entity => 'ComaDB::Result::Entity',
    {'foreign.name' => 'self.from_name'},
);

__PACKAGE__->belongs_to(to_entity => 'ComaDB::Result::Entity',
    {'foreign.name' => 'self.to_name'},
);

__PACKAGE__->belongs_to(map => 'ComaDB::Result::Map',
